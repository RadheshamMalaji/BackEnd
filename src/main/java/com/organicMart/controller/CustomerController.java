package com.organicMart.controller;
...
import com.organicMart.dto.ProductCartId;
import com.organicMart.dto.ResponseDTO;
...
import com.organicMart.services.CustomerServiceImpl;
import com.organicMart.services.EmailSenderService;
...
public class CustomerController {
	...
	public ResponseDTO<?> addOrderIdtoOrderAddress(@PathVariable int addressId, @PathVariable String orderId){
	...
	public ResponseDTO<?> getOrderAddress(@PathVariable String orderId){
	...
	public String createOrder(@RequestBody Map<String,Object> data) throws Exception {
		...
		var client=new RazorpayClient("rzp_test_qvOzalgA1CfPgJ","tsArQwgKnTqmmNMgzUcAP8SG");
	...
	@GetMapping(value="/paymentemail/{email}/{amt}")
	public ResponseEntity<?> sendPaymentConfirmationEmail(@PathVariable String email,@PathVariable int amt){
		emailService.sendEmailForPayment(email,amt );
