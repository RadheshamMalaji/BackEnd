...
import com.organicMart.services.UserServiceImpl;
...
public class UserController {
	...
	public ResponseEntity<?> generateOtp(@PathVariable String email){
		int randomNumber=userService.validateEmailAndGenearateOtp(email);
	...
	public ResponseEntity<?> changePassword(@RequestBody User credentials ){
		if(userService.changePassword(credentials.getEmail(),credentials.getPassword()))
